...
public class ProgressWheel extends View {
	...
	private int testColor = 0xAA000000;
	...
	private void setupPaints() {
		...
		testPaint.setColor(rimColor);
		testPaint.setAntiAlias(true);
		testPaint.setStyle(Style.STROKE);
		testPaint.setStrokeWidth(rimWidth);
	...
	private void parseAttributes(TypedArray a) {
		...
		testWidth = (int) a.getDimension(R.styleable.ProgressWheel_testWidth,
				testWidth);
		...
		testColor = (int) a.getColor(R.styleable.ProgressWheel_testColor,
				testColor);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawArc(circleBounds, 360, 360, false, testPaint);
		//Draw the bar
		if(isSpinning) {
		...
		canvas.drawCircle((circleBounds.width()/2) + rimWidth + paddingLeft,
				...
				circleRadius, 
				circlePaint);
		canvas.drawCircle((circleBounds.width()/2) + testWidth + paddingLeft,
				(circleBounds.height()/2) + testWidth + paddingTop,
				circleRadius,
				circlePaint);
