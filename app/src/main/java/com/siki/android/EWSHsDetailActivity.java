...
public class EWSHsDetailActivity extends AppCompatActivity {
    private static final String TAG = "EWSHsDetailActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ews_hs_detail);
        ...
        Log.d(TAG, "cekparcel-mPd-KEY_PD = EWS: " + mPd);
        Log.d(TAG, "cekparcel-mPdhs-KEY_PDHS = EWShs: " + mPdhs);
        //Log.d(TAG, "cekparcel-mPdhs.kodeHS: " + mPdhs.kodeHS);
...
/*
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                PopupUtil.showMsg(EWSHsDetailActivity.this, "Error load data", PopupUtil.SHORT);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mTitleChart2TextView.setText("Grafik Impor Berdasarkan Volume (" + Globals.bulanmin +"/"+ Globals.tahunmin + " s.d. " +  Globals.bulanmax +"/"+ Globals.tahunmax +")");
                            ...
                            mTitleChart1TextView.setText("Share Negara Asal Impor Berdasarkan Volume(" + Globals.bulanmin +"/"+ Globals.tahunmin + " s.d. " +  Globals.bulanmax +"/"+ Globals.tahunmax +")");
