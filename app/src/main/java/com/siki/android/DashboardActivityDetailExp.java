...
@SuppressLint("NewApi")
public class DashboardActivityDetailExp extends Fragment {
	...
	public DashboardActivityDetailExp() {
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(R.layout.activity_dashboard_detail_eks, container, false);
...
//		mChart14 = (BarChart) v.findViewById(R.id.chart_top_10_negara_ekspor);
		mChart15 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor);
		mChart16 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor1);
		mChart17 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor2);
		mChart18 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor3);
		mChart19 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor4);
		mChart20 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor5);
		mChart21 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor6);
		mChart22 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor7);
		mChart23 = (BarChart) v.findViewById(R.id.chart_top_10_hs_negara_ekspor8);
...
*/
	...
	private void init(View v) {
		...
		tv_title.setText("Negara Mitra Tujuan Ekspor Industri");
...
//		tv_title_chart13.setText("Top 10 Negara Mitra Impor Industri (USD) - ("+bln_max+"/"+thn_max+")");
//		tv_title_chart14.setText("Top 10 Negara Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart15.setText("HS Negara REP.RAKYAT CINA Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart16.setText("HS Negara AMERIKA SERIKAT Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart17.setText("HS Negara JEPANG Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart18.setText("HS Negara SINGAPURA Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart19.setText("HS Negara MALAYSIA Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart20.setText("HS Negara PILIPINA Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart21.setText("HS Negara INDIA Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart22.setText("HS Negara THAILAND Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
		tv_title_chart23.setText("HS Negara TAIWAN Mitra Tujuan Ekspor Industri (USD) - ("+bln_max+"/"+thn_max+")");
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=116" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=411" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=111";
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=122";
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=124" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=123" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=133" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=121" ;
		if(url == null) {
			return;
		}
...
####################################################################################################
 */
		url = Globals.base_host_bigdata   + "bar_top_10_hs_negara_impor_industri_eks?kd_negara=115" ;
		if(url == null) {
			return;
		}
