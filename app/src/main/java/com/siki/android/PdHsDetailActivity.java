...
public class PdHsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pd_hs_detail);
...
/*
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                PopupUtil.showMsg(PdHsDetailActivity.this, "Error load data", PopupUtil.SHORT);
            }
