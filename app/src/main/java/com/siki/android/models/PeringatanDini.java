...
public class PeringatanDini implements Parcelable {
    public String judul;
    ...
    public PeringatanDini() {

    }

    protected PeringatanDini(Parcel in) {
        judul = in.readString();
    ...
    public static final Creator<PeringatanDini> CREATOR = new Creator<PeringatanDini>() {
        @Override
        public PeringatanDini createFromParcel(Parcel in) {
            return new PeringatanDini(in);
        }

        @Override
        public PeringatanDini[] newArray(int size) {
            return new PeringatanDini[size];
        }
    };
}
