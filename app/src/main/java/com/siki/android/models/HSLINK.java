...
public class HSLINK implements Parcelable {
    public String judul;
    ...
    public static final Creator<HSLINK> CREATOR = new Creator<HSLINK>() {
        @Override
        public HSLINK createFromParcel(Parcel in) {
            return new HSLINK(in);
        }

        @Override
        public HSLINK[] newArray(int size) {
            return new HSLINK[size];
        }
    };
}
