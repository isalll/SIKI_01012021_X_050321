...
public class EWSHsItemAdapter extends ArrayAdapter<EWSHs> {
    public EWSHsItemAdapter(@NonNull Context context, @NonNull List<EWSHs> objects) {
        super(context, R.layout.item_ewshs, objects);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.item_ewshs, null);
        }

        EWSHs pd = getItem(position);
