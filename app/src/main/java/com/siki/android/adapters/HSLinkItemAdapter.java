...
//import com.iris.android.models.EWS;
...
public class HSLinkItemAdapter extends ArrayAdapter<HSLINK> {
    public HSLinkItemAdapter(@NonNull Context context, @NonNull List<HSLINK> objects) {
        super(context, R.layout.item_hslink, objects);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.item_hslink, null);
        }

        HSLINK pd = getItem(position);
