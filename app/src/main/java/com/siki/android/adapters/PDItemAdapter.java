...
public class PDItemAdapter extends ArrayAdapter<PeringatanDini> {
    public PDItemAdapter(@NonNull Context context, @NonNull List<PeringatanDini> objects) {
        super(context, R.layout.item_pd, objects);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.item_pd, null);
        }

        PeringatanDini pd = getItem(position);
