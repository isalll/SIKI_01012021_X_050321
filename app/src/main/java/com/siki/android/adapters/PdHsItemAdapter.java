...
public class PdHsItemAdapter extends ArrayAdapter<PdHs> {
    public PdHsItemAdapter(@NonNull Context context, @NonNull List<PdHs> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(view == null) {
            ...
            view = layoutInflater.inflate(R.layout.item_pdhs, null);
        }

        PdHs pd = getItem(position);
