...
public class EWSChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ews_chart);
        ...
        for(int i = 0; i < 3; i++) {
            ...
            mOkHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    ...
                    PopupUtil.showMsg(EWSChartActivity.this, "Error load data", PopupUtil.SHORT);
                }
